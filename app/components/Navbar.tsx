...
export default function Navbar() {
  ...
  return (
    <div
      className={
        active
          ? 'sticky top-0 bg-gray-800 text-white p-7'
          : 'sticky top-0 bg-white text-black p-7'
      }
    >
      <div className="max-w-6xl flex items-center mx-auto justify-between">
        <div
          className={
            active
              ? 'font-bold text-lg text-white uppercase cursor-pointer'
        ...
        <div className="flex space-x-6 justify-center items-center">
          ...
          {loggedIn && (
            <div
              className={
                active
                  ? 'border rounded-full p-1 cursor-pointer hover:ring-1 hover:ring-green-700'
                  : 'border rounded-full p-1 cursor-pointer hover:ring-1 hover:ring-yellow-700'
              }
            >
              <svg
                id="SvgjsSvg1016"
                ...
                <g id="SvgjsG1018">
                  ...
                  >
                    <path
                      ...
                      className={
                        active
                          ? 'color000 svgShape hover:ring-1 hover:ring-green-800 border border-yellow-400 fill-white'
                          : 'color000 svgShape'
                      }
                    ></path>
                  </svg>
